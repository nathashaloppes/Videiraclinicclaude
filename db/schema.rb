...
ActiveRecord::Schema[7.2].define(version: 2026_05_10_024824) do
  ...
  create_table "availabilities", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.check_constraint "ends_at > starts_at", name: "availabilities_time_order"
  ...
  create_table "users", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.check_constraint "role::text = ANY (ARRAY['owner'::character varying, 'dentist'::character varying, 'patient'::character varying]::text[])", name: "users_role_check"
  end
